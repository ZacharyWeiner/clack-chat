...
export default {
  async setup() {
    ...
    return { computer, publicKey, address, displayName, showEdit, balance };
  },
  components: {
    CreateProfile
  },
  methods: {
    ...
    getClasses(placement) {
      ...
      switch (placement) {
        ...
        case "profile":
          classes =
            "w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-40 mx-6 lg:mx-0";
          break;
        case "profileInner":
          classes = "p-4 md:p-12 text-center lg:text-left";
          break;
        case "mobileImage":
          classes = "block lg:hidden rounded-full shadow-xl mx-auto -mt-16 h-48 w-48 bg-cover bg-center";
          break;
        case "displayName":
